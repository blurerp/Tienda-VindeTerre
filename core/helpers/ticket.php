...
class Report extends FPDF
{
    ...
    */
    public function startReport($title)
    {
        ...
        session_start();
        // Se verifica si un cliente ha iniciado sesión para generar el ticket del pedido, de lo contrario se direcciona a main.php
        if (isset($_SESSION['id_cliente'])) {
            ...
            header('location: ../../../views/commerce/login.php');
        }
    }
    ...
    */
    public function Header()
    {
        ...
        $this->Image('../../../resources/img/logo.png', 15, 15, 30);
        // Se ubica el título.
        $this->Cell(20);
        ...
        $this->Cell(166, 10, utf8_decode('Venta de vinos importados'), 0, 1, 'C');
        // Se ubica la fecha y hora del servidor.
        $this->Cell(20);
        $this->SetFont('Arial', '', 10);
        $this->Cell(166, 10, utf8_decode('TICKET'), 0, 1, 'C');

        $this->Cell(20);
        $this->SetFont('Arial', '', 10);
        $this->Cell(166, 10, utf8_decode('REGISTRO N° 123456-7'), 0, 1, 'C');

        $this->Cell(20);
        $this->SetFont('Arial', '', 10);
        $this->Cell(166, 10, utf8_decode('NIT: 1234-312132-102-0'), 0, 1, 'C');

        $this->Cell(20);
        $this->SetFont('Arial', '', 10);
        $this->Cell(166, 10, utf8_decode('Fecha de Creación del TICKET: '.date('d-m-Y H:i:s')), 0, 1, 'C');
